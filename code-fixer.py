...
# Load project settings to include CLAUDE.md files
  async for message in query(
    prompt="""
    help me fix:
     TaskLogs.svelte not connecting to endpoint. Task Start button not working
     http://localhost:8010/run-task runs good in browser
     http://localhost:5175/run-task  sending data constantly after heartbeat
    DO NOT GENERATE ANY WRITTEN REPORTS
